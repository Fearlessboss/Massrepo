...
║──────────────────────────────────────────────────────────────────────║
║   🚀 PARALLEL FIRING — all accounts report SIMULTANEOUSLY           ║
║   🔗 Multi-message link collection (add more / skip)                 ║
║   📌 Round-robin per-round: each acc reports ALL msgs at once        ║
║   🎭 Random device fingerprinting per client (realistic iOS/Android)║
║   🏠 /groupreport — 3-button group report (spam/violence/child)      ║
║   🔒 Private channel reporting hardened (3-tier entity resolve)      ║
║   💀 POWERFUL multi-paragraph contextual report messages             ║
║   ✅ Zero "Cannot send while disconnected" — auto-reconnect          ║
║   ✅ /addaccount → Phone+OTP OR Pyrogram/Telethon session string     ║
║   ✅ /logs sends actual log FILE + /restart + sudo + gmail blast     ║
╚══════════════════════════════════════════════════════════════════════╝
"""
...
MAX_MSG_LINKS           = 20      # max message links per /report flow
BOT_VERSION             = "15.0"
...
DEVICE_FINGERPRINTS = [
    ...
    {"device_model": "iPhone 15",         "system_version": "iOS 17.3",   "app_version": "10.11.1"},
    {"device_model": "iPhone 14 Pro Max", "system_version": "iOS 16.7.2", "app_version": "10.10.1"},
    {"device_model": "iPhone 14 Pro",     "system_version": "iOS 16.6.1", "app_version": "10.9.2"},
    {"device_model": "iPhone 14",         "system_version": "iOS 16.5",   "app_version": "9.6.3"},
    {"device_model": "iPhone 13 Pro Max", "system_version": "iOS 16.4.1", "app_version": "9.5.2"},
    {"device_model": "iPhone 13 Pro",     "system_version": "iOS 16.3.1", "app_version": "9.4.1"},
    {"device_model": "iPhone 13",         "system_version": "iOS 15.7.8", "app_version": "9.3.0"},
    {"device_model": "iPhone 12 Pro",     "system_version": "iOS 15.6.1", "app_version": "9.2.2"},
    {"device_model": "iPhone 12",         "system_version": "iOS 15.5",   "app_version": "9.1.4"},
    {"device_model": "iPhone 11 Pro",     "system_version": "iOS 14.8.1", "app_version": "8.9.3"},
    {"device_model": "iPhone SE (3rd gen)","system_version":"iOS 16.6",   "app_version": "10.0.1"},
    # Android combos
    {"device_model": "Samsung SM-S928B",  "system_version": "Android 14", "app_version": "10.13.0"},
    {"device_model": "Samsung SM-S918B",  "system_version": "Android 14", "app_version": "10.12.1"},
    {"device_model": "Samsung SM-S911B",  "system_version": "Android 13", "app_version": "10.10.0"},
    {"device_model": "Samsung SM-G998B",  "system_version": "Android 13", "app_version": "10.8.2"},
    {"device_model": "Samsung SM-G991B",  "system_version": "Android 12", "app_version": "10.5.0"},
    {"device_model": "Xiaomi 14 Pro",     "system_version": "Android 14", "app_version": "10.11.2"},
    {"device_model": "Xiaomi 13",         "system_version": "Android 13", "app_version": "10.9.1"},
    {"device_model": "Xiaomi M2102J20SG", "system_version": "Android 12", "app_version": "10.4.3"},
    {"device_model": "OnePlus 12",        "system_version": "Android 14", "app_version": "10.12.0"},
    {"device_model": "OnePlus 11",        "system_version": "Android 13", "app_version": "10.7.1"},
    {"device_model": "OnePlus 9 Pro",     "system_version": "Android 12", "app_version": "10.3.0"},
    {"device_model": "Google Pixel 8 Pro","system_version": "Android 14", "app_version": "10.13.1"},
    {"device_model": "Google Pixel 7",    "system_version": "Android 13", "app_version": "10.8.0"},
    {"device_model": "Google Pixel 6a",   "system_version": "Android 13", "app_version": "10.5.2"},
    {"device_model": "Realme RMX3686",    "system_version": "Android 13", "app_version": "10.6.1"},
    {"device_model": "Vivo V2312",        "system_version": "Android 14", "app_version": "10.10.2"},
    {"device_model": "OPPO CPH2531",      "system_version": "Android 13", "app_version": "10.7.0"},
]

LANG_CODES = [
    ("en", "en-US"), ("en", "en-GB"), ("en", "en-IN"),
    ("hi", "hi-IN"), ("en", "en-CA"), ("en", "en-AU"),
]

def random_device_fingerprint() -> dict:
    """Pick a random realistic device + lang combo."""
    dev = random.choice(DEVICE_FINGERPRINTS)
    lang, sys_lang = random.choice(LANG_CODES)
    return {
...
def print_banner():
    ...
    print(f"  ⚡ Ultimate Reporter v{BOT_VERSION} — PARALLEL ENGINE running...{C.RESET}")
...
class ColorFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        lvl = f"{col}{record.levelname:<5}{C.RESET}"
...
(PHONE, CODE, PASSWORD, RM_PHONE,
 GRP_LINK, MSG_LINK, MSG_MORE, REASON_CAT, REASON_SUB, CUSTOM_MSG, COUNT,
 ...
 GR_LINK, GR_REASON, GR_CUSTOM_MSG, GR_MSG_LINK, GR_COUNT) = range(31)
...
# ══════════════════════════════════════════════════════════════════════
# 🔥 POWERFUL REPORT MESSAGE POOLS
# ══════════════════════════════════════════════════════════════════════
REALISTIC_REPORT_MSGS = [
    "This account is repeatedly engaging in harmful and illegal activity on Telegram. Multiple users have already raised concerns. Immediate action is requested.",
    "I am reporting this content because it clearly violates Telegram's Terms of Service. The material is offensive, unsafe and damaging to the community.",
    "This user is targeting minors and vulnerable people. The content shared is disturbing and must be removed without delay. Please ban this account permanently.",
    "Highly inappropriate, explicit and harmful content has been distributed by this user. This is a direct violation of Telegram's community guidelines.",
    "This account is involved in spreading scams, phishing and fraud. Many victims have lost money. Strong action is necessary to protect other users.",
    "Hate speech, incitement and threats are being posted from this account. As a Telegram user I demand immediate review and permanent suspension.",
    "I have personally witnessed multiple violations from this account over the last few days. It is clearly being used as a tool for abuse and must be stopped.",
    "This account is impersonating another real person/brand to mislead and defraud users. The deception is obvious and dangerous. Please verify and remove.",
    "Copyrighted material is being uploaded and redistributed here without permission. The rights holders have not authorized any of this content.",
    "This profile is being used to coordinate harassment campaigns against specific users. The behavior is targeted, sustained and emotionally damaging.",
]
REPORT_PREFIXES = [
    "I am formally reporting this content/account.",
    "Submitting this report on behalf of multiple affected users.",
    "Urgent moderation review required for this account.",
    "This is a serious violation that requires immediate enforcement.",
    "Filing this report as a concerned Telegram community member.",
    "Reporting for severe and ongoing Terms of Service violations.",
]
CONTEXT_PHRASES = [
    "Several screenshots and chat logs are available on request as evidence.",
    "Multiple users in shared groups have independently confirmed this behavior.",
    "This is not a one-time incident — the pattern has been ongoing for weeks.",
    "The content directly endangers minors and other vulnerable users.",
    "The same account has already been reported multiple times by other users.",
    "Allowing this to continue puts the safety of the wider Telegram community at risk.",
]
CLOSING_PHRASES = [
    "Please take swift action against this account.",
    "I trust the Telegram safety team will handle this with priority.",
    "Kindly suspend this user permanently and remove all related content.",
    "Immediate enforcement is essential to prevent further harm.",
    "Thank you for protecting the platform and its users.",
]
...
# ══════════════════════════════════════════════════════════════════════
# 📋 FULL TELEGRAM REPORT CATEGORIES
# ══════════════════════════════════════════════════════════════════════
FULL_REPORT_CATEGORIES = {
    "spam": {
        ...
        "subs": [
            ...
            ("bot",      "🤖 Bot Activity / Mass Messages"),
            ("repeat",   "🔁 Repeated Identical Content"),
            ("other",    "📋 Other Spam"),
        ],
    },
    "violence": {
    ...
    "pornography": {
        ...
        "subs": [
            ("explicit", "🔞 Explicit Material"),
            ("nonconsent","🚫 Non-consensual Content"),
            ("other",    "📋 Other"),
        ],
    },
    "child_abuse": {
        ...
        "subs": [
            ("csam",     "🚨 CSAM"),
            ("grooming", "⚠️ Grooming / Solicitation"),
            ("other",    "📋 Other Child Harm"),
        ],
    },
    "fake": {
        "emoji": "🎭", "label": "Fake / Impersonation",
        "api": types.InputReportReasonFake(),
        "subs": [
            ("imp_user", "👤 Impersonation of User"),
            ("imp_brand","🏢 Impersonation of Brand"),
            ("scam",     "💸 Scam / Fraud"),
            ("other",    "📋 Other Fake"),
        ],
    },
    ...
    "personal": {
        ...
        "subs": [
            ("doxxing",  "📍 Doxxing / Leaked Info"),
            ("private",  "📞 Private Contact Info"),
...
# ══════════════════════════════════════════════════════════════════════
# 🏠 GROUP-REPORT SHORT REASONS (3-button upper-menu)
# ══════════════════════════════════════════════════════════════════════
GROUP_REPORT_REASONS = {
    "gr_spam":     ("📢 Spam",        types.InputReportReasonSpam()),
    "gr_violence": ("🔪 Violence",     types.InputReportReasonViolence()),
    "gr_child":    ("👶 Child Abuse",  types.InputReportReasonChildAbuse()),
}
    ...
    try:
        ...
        if PROXY_ENABLED and phone:
            ...
            try:
                ...
                sess = client.session
                dev = account_device_map.get(phone) or random_device_fingerprint()
...
def load_accounts():
    ...
    for i, (phone, sess) in enumerate(data.items()):
        try:
            ...
            # Each loaded account gets its own random device fingerprint
            device = random_device_fingerprint()
            ...
            add_log(f"✅ Loaded: {phone} [{device['device_model'][:18]} / {device['system_version']}]")
        except Exception as e:
...
async def try_load_session_string(session_str: str) -> Tuple[Optional[TelegramClient], Optional[str], str]:
    ...
    try:
        ...
        if telethon_str:
            client = build_client(StringSession(telethon_str), proxy, device)
            await asyncio.wait_for(client.connect(), timeout=15)
            if await client.is_user_authorized():
                me = await client.get_me()
                phone = me.phone if me.phone else None
...
def parse_group_link(link: str) -> Tuple[Optional[str], Optional[str], str]:
    try:
        ...
        if "/+" in link or "/joinchat/" in link:
            ...
            parts = link.split("/")
            # for /c/CHANID or /c/CHANID/MSGID — group root is /c/CHANID
            if parts[-1].isdigit() and parts[-2] == "c":
                uname = parts[-1]
...
async def join_group_all(identifier, link_type) -> Tuple[int, int]:
    ...
    ok, fail = 0, 0
    # Parallel join — much faster
    async def _join_one(phone):
        ...
        try:
            if link_type == "invite":
                try:
                    ...
                    add_log(f"✅ Joined (invite): {phone[-4:]}")
                    return True
                except errors.UserAlreadyParticipantError:
                    add_log(f"✅ Already member: {phone[-4:]}")
                    return True
                except errors.InviteHashExpiredError:
                    add_log(f"❌ Expired invite: {phone[-4:]}")
                    return False
                except errors.InviteHashInvalidError:
                    add_log(f"❌ Invalid invite: {phone[-4:]}")
                    return False
                except Exception as e:
                    add_log(f"❌ Invite join fail: {phone[-4:]} — {type(e).__name__}")
                    return False
            elif link_type == "private_channel":
                try:
                    await client(JoinChannelRequest(identifier))
                    add_log(f"✅ Joined (private ch): {phone[-4:]}")
                    return True
                except errors.UserAlreadyParticipantError:
                    add_log(f"✅ Already member: {phone[-4:]}")
                    return True
                except Exception as e:
                    add_log(f"❌ Private ch join fail: {phone[-4:]} — {type(e).__name__}")
                    return False
        except Exception as e:
            add_log(f"❌ Join error: {phone[-4:]} — {type(e).__name__}")
            return False
        return False

    results = await asyncio.gather(*[_join_one(p) for p in list(accounts.keys())],
...
# ══════════════════════════════════════════════════════════════════════
# 🎯 ENTITY RESOLVER — hardened for private channels
# ══════════════════════════════════════════════════════════════════════
async def resolve_chat_entity(client, identifier: str, link_type: str):
    """3-tier resolver: numeric variations → input_entity → get_entity → dialogs scan."""
    # Tier 1: numeric channel IDs (covers private channels)
    if str(identifier).lstrip("-").isdigit():
        ...
        for candidate in (int(f"-100{raw}"), int(raw), -int(raw)):
            try:
                ...
                continue
        # Tier 1b: also try GetFullChannel as channel
        try:
            return await client.get_input_entity(
                tl_types.PeerChannel(channel_id=int(raw))
            )
        except Exception:
            pass

    # Tier 2: direct input entity
    try:
        return await client.get_input_entity(identifier)
    except Exception:
        pass

    # Tier 3: get_entity then input_entity
    try:
    ...
    # Tier 4 (last resort for private channels): scan dialogs
    try:
        async for d in client.iter_dialogs(limit=200):
            try:
                did = d.id
                if str(did).lstrip("-").endswith(str(identifier).lstrip("-")):
                    return await client.get_input_entity(d.entity)
            except Exception:
                continue
    except Exception as e:
        raise e
    raise ValueError(f"Cannot resolve entity for {identifier}")

# ══════════════════════════════════════════════════════════════════════
# 🚀 CORE MESSAGE REPORT ENGINE (with auto-reconnect)
# ══════════════════════════════════════════════════════════════════════
async def send_report(phone, channel_id, msg_id, reason_api, custom_msg,
    ...
    try:
        ...
        await asyncio.sleep(random.uniform(0.05, 0.25))  # fast micro-jitter
        ...
        try:
            ...
            if result:
                ...
                add_log(f"✅ M1 OK: {phone[-4:]} (msg {msg_id_int})")
...
# ══════════════════════════════════════════════════════════════════════
# ⏱ DELAYS — drastically shortened for FAST mode
# ══════════════════════════════════════════════════════════════════════
def micro_jitter() -> float:
    return random.uniform(0.05, 0.20)

def round_jitter() -> float:
...
async def start_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    welcome = (
        ...
        f"<i>CYBER JUSTICE ELITE++ • PARALLEL ENGINE</i>\n"
        f"━━━━━━━━━━━━━━━━━━━━\n\n"
...
async def menu_router(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    info_map = {
        "report":        ("📩 <b>Message Report</b>\n\nUse /report — multi-link, parallel firing, all accounts at once.", "/report"),
        "groupreport":   ("🏠 <b>Group Report</b>\n\nUse /groupreport — 3-button group report (spam/violence/child).", "/groupreport"),
...
async def help_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "━━━━━━━━━━━━━━━━━━━━\n\n"
        "🎯 /report — Multi-message report (parallel)\n"
        "🏠 /groupreport — Group report (3-button)\n"
        "📸 /accountreport — Nuclear PFP report\n"
        "🤖 /botreport — Report a bot (full categories)\n"
        "📧 /massgmail — Gmail blast × N\n"
        "➕ /addaccount — Add account (Phone+OTP OR Session String)\n"
        ...
        "📊 /logs — Send activity log FILE\n"
        "🧹 /clearlogs — Clear logs & stats\n"
        "♻️ /restart — Restart bot (sessions preserved)\n"
        "❌ /cancel — Cancel current flow\n\n"
        "👑 Owner: /sudo /rmsudo /sudolist\n\n"
        "💡 <b>v15.0 highlights:</b>\n"
        "  • Parallel firing — all accounts at once\n"
        "  • Multi-message support (add more / skip)\n"
        "  • Random device fingerprinting per client\n"
        "  • Private channel reporting hardened\n",
        parse_mode="HTML"
    )
...
async def allaccounts_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    for i, (phone, client) in enumerate(accounts.items(), 1):
        try:
            ...
            d_txt = f" [{dev.get('device_model','?')[:14]}]" if dev else ""
        except:
            status = "🔴 Inactive"; d_txt = ""
        txt += f"{i}. <code>{phone}</code> — {status}{d_txt}\n"
    txt += f"\n📊 Total: <b>{len(accounts)}</b> | 🟢 {active} | 🔴 {len(accounts)-active}"
    await update.message.reply_text(txt, parse_mode="HTML")

async def proxystatus_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    if not is_authorized(update.effective_user.id): return
    mode = "🟢 <b>ENABLED</b>" if PROXY_ENABLED else "⚡ <b>DISABLED</b> (direct mode)"
    if not PROXY_LIST:
        await update.message.reply_text(
            f"🌐 Proxy Mode: {mode}\n\n📭 No proxies in pool.\nUse /reloadproxies to fetch.",
            parse_mode="HTML"); return
    txt = f"🌐 Proxy Mode: {mode}\nPool: <b>{len(PROXY_LIST)}</b> total\n\n"
    shown = 0
    for p in PROXY_LIST:
        if shown >= 20:
            txt += f"\n…and {len(PROXY_LIST) - shown} more"; break
        k = _proxy_key(p)
...
async def proxyon_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    PROXY_ENABLED = True
    await update.message.reply_text(
        "🟢 <b>Proxy mode: ENABLED</b>\n\n⚠️ Free proxies are often dead — if errors, run /proxyoff.",
        parse_mode="HTML")
...
async def add_phone(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if looks_like_session_string(raw):
        ...
        # Assign random device fingerprint for this account
        account_device_map[ident] = random_device_fingerprint()
        save_accounts()
        add_log(f"✅ Added via session string: {ident}")
        await wait_msg.edit_text(
            f"✅ <b>Logged in via session string!</b>\n📱 <code>{ident}</code>\n📊 Total accounts: <b>{len(accounts)}</b>",
            parse_mode="HTML")
        return ConversationHandler.END
    ...
    try:
        ...
        await update.message.reply_text(
            "📩 <b>OTP sent!</b>\n\nEnter the code you received.\n💡 Add spaces between digits if Telegram blocks raw code:\n    e.g. <code>1 2 3 4 5</code>",
            parse_mode="HTML")
...
def _build_msg_more_keyboard():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("➕ Add another message", callback_data="MORE|add"),
         InlineKeyboardButton("⏭️ Skip / Done",         callback_data="MORE|skip")]
    ])

def _build_group_report_keyboard():
    """3 buttons upar — spam/violence/child."""
    rows = []
    for key, (label, _) in GROUP_REPORT_REASONS.items():
        rows.append([InlineKeyboardButton(label, callback_data=f"GR|{key}")])
    return InlineKeyboardMarkup(rows)

# ══════════════════════════════════════════════════════════════════════
# 🎯 /report — MULTI-MSG PARALLEL FLOW
# ══════════════════════════════════════════════════════════════════════
async def report_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    ctx.user_data["msg_links"] = []   # list of (ident, msg_id, link)
    add_log("🎯 Report flow started")
    await update.message.reply_text(
        f"🎯 <b>REPORT FLOW</b> — Step 1\n\n"
        ...
        f"  • Private channel → <code>t.me/c/1234567890</code>\n\n"
        f"/cancel to abort.",
        parse_mode="HTML")
    return GRP_LINK
...
async def receive_grp_link(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if ltype == "username":
        await update.message.reply_text(
            ...
            f"📥 <b>Step 2</b> — Send <b>MESSAGE LINK</b>:\n"
        ...
        await update.message.reply_text(
            f"✅ Join complete!\n✅ {ok} | ❌ {fail}\n\n"
            f"📥 <b>Step 2</b> — Send <b>MESSAGE LINK</b>:", parse_mode="HTML")
    return MSG_LINK
...
async def receive_msg_link(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    ctx.user_data["msg_links"].append((ident, msg_id, link))
    count = len(ctx.user_data["msg_links"])
    add_log(f"📥 Message #{count}: {link} (ID:{msg_id})")
    if count >= MAX_MSG_LINKS:
        await update.message.reply_text(
            f"✅ Max {MAX_MSG_LINKS} message links reached.\n\n📋 Select report reason:",
            reply_markup=_build_full_cat_keyboard("CAT"),
            parse_mode="HTML")
        return REASON_CAT
    await update.message.reply_text(
        f"✅ Message #{count} saved!\n\n"
        f"और message link भेजना है या skip?\n\n"
        f"📊 Collected: <b>{count}</b> message link(s)",
        reply_markup=_build_msg_more_keyboard(),
        parse_mode="HTML")
    return MSG_MORE

async def msg_more_cb(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    query = update.callback_query
    await query.answer()
    _, action = query.data.split("|", 1)
    if action == "add":
        await query.edit_message_text(
            f"📥 Send next <b>MESSAGE LINK</b>:\n"
            f"(Collected: <b>{len(ctx.user_data['msg_links'])}</b>)",
            parse_mode="HTML")
        return MSG_LINK
    # skip → reason
    if not ctx.user_data["msg_links"]:
        await query.edit_message_text("❌ No messages collected!"); return ConversationHandler.END
    await query.edit_message_text(
        f"✅ Collected <b>{len(ctx.user_data['msg_links'])}</b> message(s)\n\n"
...
async def category_selected(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if len(parts) < 2 or parts[1] == "back":
        await query.edit_message_text(
            "📋 Select report reason:",
            reply_markup=_build_full_cat_keyboard("CAT"))
        return REASON_CAT
    ...
    if cat_key not in FULL_REPORT_CATEGORIES:
        await query.edit_message_text("❌ Invalid category."); return ConversationHandler.END
    cat = FULL_REPORT_CATEGORIES[cat_key]
    ...
    if not cat["subs"]:
        ...
        if cat_key == "other":
            await query.edit_message_text(
                ...
                f"🔢 <b>Step 6</b> — Reports per account (1–{MAX_REPORTS_PER_ACCOUNT}):",
                parse_mode="HTML")
            return COUNT
        await query.edit_message_text(
            f"✅ {cat['emoji']} <b>{cat['label']}</b>\n\n"
...
async def subcategory_selected(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if len(parts) >= 2 and parts[1] == "back":
        ...
        return REASON_CAT
    if len(parts) < 3:
        await query.edit_message_text("❌ Invalid selection."); return ConversationHandler.END
...
async def receive_custom_msg(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        f"Enter <b>1–{MAX_REPORTS_PER_ACCOUNT}</b>:", parse_mode="HTML")
    return COUNT
...
async def report_execute(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        await update.message.reply_text(f"❌ 1-{MAX_REPORTS_PER_ACCOUNT} valid range. Try again:")
        return COUNT

    ident          = ctx.user_data["grp_ident"]
    link_type      = ctx.user_data["grp_type"]
    msg_links      = ctx.user_data["msg_links"]   # list of (ident, msg_id, link)
    reason_api     = ctx.user_data["reason_api"]
    custom_msg     = ctx.user_data.get("custom_msg", "")
    cat_key        = ctx.user_data["cat_key"]
    cat_lbl        = FULL_REPORT_CATEGORIES[cat_key]["label"]
    sub_lbl        = ctx.user_data["sub_label"]
    ...
    msg_count        = len(msg_links)
    total_planned    = msg_count * len(auth_pairs) * count
    report_stats["total"]      = total_planned
    report_stats["start_time"] = datetime.now()
    start              = time.time()
    join_note          = "Public group (no join)" if link_type == "username" else "Private group (joined)"

    await update.message.reply_text(
        f"🚀 <b>PARALLEL REPORTING STARTED</b>\n\n"
        f"📊 Total reports: <b>{total_planned}</b>\n"
        f"📩 Messages: <b>{msg_count}</b>\n"
        f"📱 Accounts: <b>{len(auth_pairs)}</b> × {count} rounds\n"
        f"⚠️ {cat_lbl} → {sub_lbl}\n"
        f"⚡ Mode: <b>ALL ACCOUNTS FIRE SIMULTANEOUSLY per round</b>\n"
        f"   (each acc reports ALL {msg_count} msg(s) in parallel)\n"
        f"🌐 {join_note}\n"
        f"━━━━━━━━━━━━━━━━━━━━", parse_mode="HTML")
    ...
    async def _fire_one_account_all_msgs(phone: str, round_no: int):
        """Fire ALL messages from this account in parallel."""
        async def _one_msg(m_ident, m_id, m_link):
            ok, status = await send_report(
                phone, m_ident, m_id, reason_api, custom_msg,
                link_type, sub_lbl)
            return (phone, m_id, m_link, ok, status, round_no)
        tasks = [_one_msg(m_ident, m_id, m_link) for (m_ident, m_id, m_link) in msg_links]
        return await asyncio.gather(*tasks, return_exceptions=True)

    for r in range(1, count + 1):
        round_start = time.time()
        # Fire ALL accounts in parallel; each account fires ALL msgs in parallel
        per_acc_tasks = [_fire_one_account_all_msgs(p, r) for p, _ in auth_pairs]
        all_results = await asyncio.gather(*per_acc_tasks, return_exceptions=True)

        flood_wait_secs = 0
        for acc_results in all_results:
            if isinstance(acc_results, Exception):
                total_fail += len(msg_links)
                continue
            for res in acc_results:
                if isinstance(res, Exception):
                    total_fail += 1
                    continue
                phone, m_id, m_link, ok, status, round_no = res
                if ok:
                    total_ok += 1; per_acc_ok[phone] += 1; update_stats(True)
                    log_report_file(phone, m_id, f"{cat_lbl}/{sub_lbl}", "SUCCESS", status)
                else:
                    total_fail += 1; per_acc_fail[phone] += 1; update_stats(False)
                    log_report_file(phone, m_id, f"{cat_lbl}/{sub_lbl}", "FAILED", status)
                    if "FloodWait" in status:
                        try:
                            w = int(status.split()[1].replace("s",""))
                            flood_wait_secs = max(flood_wait_secs, w)
                        except: pass

        round_elapsed = time.time() - round_start
        await update.message.reply_text(
            f"✅ <b>Round {r}/{count}</b> done in <b>{round_elapsed:.1f}s</b>\n"
            f"   ✅ Success so far: {total_ok} | ❌ Failed: {total_fail}",
            parse_mode="HTML")

        if flood_wait_secs > 0:
            wait_s = min(flood_wait_secs + 2, 300)
            await update.message.reply_text(f"⏳ FloodWait — waiting {wait_s}s before next round...")
            await asyncio.sleep(wait_s)
        elif r < count:
            await asyncio.sleep(round_jitter())

    elapsed = int(time.time() - start)
    rate    = (total_ok / total_planned) * 100 if total_planned > 0 else 0
    add_log(f"🎉 Done: {total_ok}/{total_planned} ({rate:.1f}%) in {elapsed}s")

    breakdown = "\n".join(
        f"  📱 <code>{p[-4:]}</code> → ✅ {per_acc_ok[p]} | ❌ {per_acc_fail[p]}"
        for p, _ in auth_pairs)

    msg_summary = "\n".join(f"  • <code>{l}</code>" for _, _, l in msg_links)
...
# ══════════════════════════════════════════════════════════════════════
# 🏠 /groupreport — 3 button upar (spam/violence/child)
# ══════════════════════════════════════════════════════════════════════
async def groupreport_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        f"⚡ Parallel firing • Selects message + reports group via clicking the button\n\n"
        f"📥 Send <b>GROUP / CHANNEL LINK</b> first:\n"
        f"  • <code>t.me/groupname</code>\n"
        f"  • <code>t.me/+invitehash</code>\n"
        f"  • <code>t.me/c/1234567890</code>\n\n"
        f"/cancel to abort.",
        parse_mode="HTML")
    return GR_LINK

async def gr_receive_link(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    link  = update.message.text.strip()
    ident, ltype, err = parse_group_link(link)
    if err:
        await update.message.reply_text(f"❌ {err}\nTry again or /cancel"); return GR_LINK
    ctx.user_data.update({"gr_ident": ident, "gr_type": ltype, "gr_link": link})
    add_log(f"🏠 GroupReport target: {link} ({ltype})")
    if ltype != "username":
        await update.message.reply_text(f"🔄 Joining private group (parallel)...\n<code>{link}</code>", parse_mode="HTML")
        ok, fail = await join_group_all(ident, ltype)
        if ok == 0:
            await update.message.reply_text("❌ No accounts could join!"); return ConversationHandler.END
        await update.message.reply_text(f"✅ Joined: {ok} | ❌ Failed: {fail}", parse_mode="HTML")
    await update.message.reply_text(
        f"📥 Now send a <b>MESSAGE LINK</b> from this group\n"
        f"(this message will be the selected one when reporting):\n\n"
        f"  • <code>t.me/groupname/123</code>\n"
        f"  • <code>t.me/c/1234567890/123</code>",
        parse_mode="HTML")
    return GR_MSG_LINK
...
async def gr_receive_msg_link(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    link = update.message.text.strip()
    m_ident, m_id, err = parse_message_link(link)
    if err:
        await update.message.reply_text(f"❌ {err}\nTry again or /cancel"); return GR_MSG_LINK
    ctx.user_data["gr_msg_ident"] = m_ident
    ctx.user_data["gr_msg_id"]    = m_id
    ctx.user_data["gr_msg_link"]  = link
    add_log(f"🏠 GR msg: {link} (ID:{m_id})")
    await update.message.reply_text(
        f"✅ Message saved!\n\n"
        f"⚠️ <b>Select report reason</b> (top 3 buttons):",
        reply_markup=_build_group_report_keyboard(),
        parse_mode="HTML")
    return GR_REASON

async def gr_reason_selected(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    query = update.callback_query
    await query.answer()
    _, reason_key = query.data.split("|", 1)
    if reason_key not in GROUP_REPORT_REASONS:
        await query.edit_message_text("❌ Invalid reason."); return ConversationHandler.END
    label, api = GROUP_REPORT_REASONS[reason_key]
    ctx.user_data["gr_reason_label"] = label
    ctx.user_data["gr_reason_api"]   = api
    await query.edit_message_text(
        f"✅ {label} selected\n\n"
        f"📝 Optional reason message (paste any text) or send <code>skip</code>:",
        parse_mode="HTML")
...
async def gr_execute(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        await update.message.reply_text(f"❌ 1-{MAX_REPORTS_PER_ACCOUNT}. Try again:")
        return GR_COUNT

    grp_ident      = ctx.user_data["gr_ident"]
    grp_type       = ctx.user_data["gr_type"]
    grp_link       = ctx.user_data["gr_link"]
    m_ident        = ctx.user_data["gr_msg_ident"]
    m_id           = ctx.user_data["gr_msg_id"]
    m_link         = ctx.user_data["gr_msg_link"]
    reason_api     = ctx.user_data["gr_reason_api"]
    reason_label   = ctx.user_data["gr_reason_label"]
    ...
    await update.message.reply_text(
        f"🚀 <b>GROUP REPORT STARTED</b>\n\n"
        f"🏠 Group: <code>{grp_link}</code>\n"
        f"📩 Selected message: <code>{m_link}</code> (ID:{m_id})\n"
        f"⚠️ Reason: {reason_label}\n"
        f"📱 Accounts: <b>{len(auth_pairs)}</b> × {count} rounds\n"
    ...
    async def _fire_one(phone, r):
        # Reports the selected message; the message-link's group is auto-derived
        ok, status = await send_report(
            phone, m_ident, m_id, reason_api, custom_msg,
            grp_type, reason_label)
        return (phone, ok, status, r)

    for r in range(1, count + 1):
        round_start = time.time()
        tasks = [_fire_one(p, r) for p, _ in auth_pairs]
        results = await asyncio.gather(*tasks, return_exceptions=True)
        flood_wait_secs = 0
        for res in results:
            if isinstance(res, Exception):
                total_fail += 1; continue
            phone, ok, status, _r = res
            if ok:
                total_ok += 1; per_acc_ok[phone] += 1
                log_report_file(phone, m_id, f"GROUP/{reason_label}", "SUCCESS", status)
            else:
                total_fail += 1; per_acc_fail[phone] += 1
                log_report_file(phone, m_id, f"GROUP/{reason_label}", "FAILED", status)
                if "FloodWait" in status:
                    try:
                        w = int(status.split()[1].replace("s",""))
                        flood_wait_secs = max(flood_wait_secs, w)
        ...
        round_elapsed = time.time() - round_start
        await update.message.reply_text(
            f"✅ <b>Round {r}/{count}</b> in <b>{round_elapsed:.1f}s</b> | ✅ {total_ok} | ❌ {total_fail}",
            parse_mode="HTML")
        if flood_wait_secs > 0:
            wait_s = min(flood_wait_secs + 2, 300)
            await update.message.reply_text(f"⏳ FloodWait — waiting {wait_s}s...")
            await asyncio.sleep(wait_s)
        elif r < count:
            await asyncio.sleep(round_jitter())
...
async def accountreport_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        f"✅ Active: <b>{active}/{len(accounts)}</b>\n"
        f"💀 6 methods + fallbacks • Parallel firing\n\n"
...
async def ar_execute(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        await update.message.reply_text(f"❌ 1-{MAX_REPORTS_PER_ACCOUNT}. Try again:"); return AR_COUNT

    target_raw    = ctx.user_data["ar_entity_id"]
    target_name   = ctx.user_data["ar_name"]
    ...
    start         = time.time()
    await update.message.reply_text(
        f"🚀 <b>NUCLEAR PFP REPORT (PARALLEL)</b>\n👤 {target_name}\n⚠️ {reason_label}\n"
        f"📊 {total_reports} total ({len(auth_pairs)} × {count})\n"
        f"⚡ All accounts fire simultaneously per round\n━━━━━━━━━━━━━━━━",
        parse_mode="HTML")

    resolved: Dict[str, Tuple[object, list]] = {}
    async def _resolve_one(phone, client):
        try:
            ...
            return (phone, ent, ph, None)
        except Exception as e:
            return (phone, None, [], str(e)[:40])
    res = await asyncio.gather(*[_resolve_one(p, c) for p, c in auth_pairs], return_exceptions=True)
    for r in res:
    ...
    for r in range(1, count + 1):
        ...
        await update.message.reply_text(
            ...
            parse_mode="HTML")
        if flood_wait_secs > 0:
            await asyncio.sleep(min(flood_wait_secs + 2, 300))
        elif r < count:
            await asyncio.sleep(round_jitter())
...
async def botreport_cmd(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        f"🤖 <b>BOT REPORT</b>\n━━━━━━━━━━━━━━━━\n\n"
        f"✅ Active: <b>{active}/{len(accounts)}</b>\n"
        f"💀 Full TG categories • Parallel firing\n\n"
...
async def br_category_selected(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    cat_key = parts[1]
    if cat_key not in FULL_REPORT_CATEGORIES:
        await query.edit_message_text("❌ Invalid."); return ConversationHandler.END
    cat = FULL_REPORT_CATEGORIES[cat_key]
...
async def br_execute(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        await update.message.reply_text(f"❌ 1-{MAX_REPORTS_PER_ACCOUNT}. Try again:"); return BR_COUNT

    target_raw   = ctx.user_data["br_entity_id"]
    target_name  = ctx.user_data["br_name"]
    cat_key      = ctx.user_data["br_cat_key"]
    cat_label    = FULL_REPORT_CATEGORIES[cat_key]["label"]
    sub_label    = ctx.user_data["br_sub_label"]
    ...
    async def _resolve_one(phone, client):
        try:
            ent = await client.get_entity(target_raw.lstrip("@"))
            return (phone, ent, None)
        except Exception as e:
            return (phone, None, str(e)[:40])
    res_list = await asyncio.gather(*[_resolve_one(p, c) for p, c in auth_pairs], return_exceptions=True)
    for r in res_list:
        if isinstance(r, Exception): continue
        phone, ent, err = r
        resolved[phone] = ent
    ...
    for r in range(1, count + 1):
        round_start = time.time()
        tasks = [_fire_bot(p) for p, _ in auth_pairs]
        results = await asyncio.gather(*tasks, return_exceptions=True)
        flood_wait_secs = 0
        for res in results:
            if isinstance(res, Exception):
...
async def receive_blast_count(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> int:
    try:
        ...
        await update.message.reply_text("❌ 1-50. Try again:"); return MAIL_BLAST_COUNT
    ...
    await update.message.reply_text(
        ...
        f"🔁 Rounds: <b>{count}</b>\n📧 Accounts/round: <b>{len(GMAIL_ACCOUNTS)}</b>\n"
        f"📊 Total emails: <b>{count * len(GMAIL_ACCOUNTS)}</b>\n\n⏳ Firing now...", parse_mode="HTML")
...
def main():
    ...
    report_conv = ConversationHandler(
        ...
        states={
            ...
            MSG_MORE:   [CallbackQueryHandler(msg_more_cb, pattern="^MORE\\|")],
    ...
    group_report_conv = ConversationHandler(
        ...
        states={
            GR_LINK:       [MessageHandler(filters.TEXT & ~filters.COMMAND, gr_receive_link)],
            GR_MSG_LINK:   [MessageHandler(filters.TEXT & ~filters.COMMAND, gr_receive_msg_link)],
            GR_REASON:     [CallbackQueryHandler(gr_reason_selected, pattern="^GR\\|")],
    ...
    logger.info(f"⚡ ULTIMATE REPORTER v{BOT_VERSION} — PARALLEL ENGINE RUNNING")
